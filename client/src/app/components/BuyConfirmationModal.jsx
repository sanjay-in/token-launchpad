...
const BuyConfirmationModal = ({ type, closeModal, show, amountOfTokens }) => {
  const successDescription = `You have succesfully purchased ${amountOfTokens} tokens.`;
  const errorDescription = "Failed to purchase token. Please try again after some time.";
